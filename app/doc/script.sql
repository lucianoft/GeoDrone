...
CREATE TABLE GEO_DISPOSITIVO (
	ID_DISPOSITIVO BIGINT(20) PRIMARY KEY AUTO_INCREMENT,
	DT_SINCRONIZACAO DATETIME NOT NULL,
	DT_INCLUSAO DATETIME NOT NULL,
	DT_ALTERACAO DATETIME NOT NULL,
	VERSAO_SISTEMA BIGINT(5) NOT NULL
...
CREATE TABLE GEO_TIPO_CULTIVO (
	ID_TIPO_CULTIVO BIGINT(20) PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE GEO_DOENCA (
	ID_DOENCA BIGINT(20) PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE GEO_PRAGA (
	ID_PRAGA BIGINT(20) PRIMARY KEY AUTO_INCREMENT,
	DESCRICAO VARCHAR(100) NOT NULL,
    DESCRICAO_CIENTIFICA VARCHAR(100) NOT NULL,
    ID_TIPO_CULTIVO BIGINT(20),
	IND_ATIVO INT(1) NOT NULL,
...
CREATE TABLE GEO_ROTA_TRABALHO (
	ID_ROTA_TRABALHO_DISP BIGINT(20) PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE GEO_PONTO_COLETA_CHUVA (
	ID_PONTO_COLETA_CHUVA_DISP BIGINT(20) PRIMARY KEY AUTO_INCREMENT,
	DESCRICAO VARCHAR(100) NOT NULL,
    LATITUDE NUMERIC(20,10) NOT NULL,
    LONGITUDE NUMERIC(20,10) NOT NULL,
...
CREATE TABLE GEO_REGISTRO_CHUVA (
	ID_REGISTRO_CHUVA_DISP BIGINT(20) PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE GEO_REGISTRO_PRAGA (
	ID_REGISTRO_PRAGA_DISP BIGINT(20) PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE GEO_REGISTRO_DOENCA (
	ID_REGISTRO_DOENCA_DISP BIGINT(20) PRIMARY KEY AUTO_INCREMENT,
	OBSERVACAO VARCHAR(100) ,
    LATITUDE NUMERIC(20,10) NOT NULL,
    LONGITUDE NUMERIC(20,10) NOT NULL,
...
CREATE TABLE GEO_REGISTRO_IMAGEM (
	ID_REGISTRO_IMAGEM_DISP BIGINT(20) PRIMARY KEY AUTO_INCREMENT,
	OBSERVACAO VARCHAR(100) ,
    LATITUDE NUMERIC(20,10) NOT NULL,
    LONGITUDE NUMERIC(20,10) NOT NULL,
