...
public class RelatorioRegistroChuvaActivity extends BaseRelatorioActivity implements DatePickerDialog.OnDateSetListener,
        RelatorioRegistroChuvaPresenter.View{
    ...
    private RelatorioRegistroChuvaPresenter requisitarArquivoChuvaPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_relatorio_registro_chuva);
        ...
        if (!Util.verificaConexao(this)) {
            ...
            requisitarArquivoChuvaPresenter = new RelatorioRegistroChuvaPresenter(this);
    ...
    public void onPostCreate(Bundle savedInstanceState) {
        ...
        requisitarArquivoChuvaPresenter.takeView(this);
    }
    ...
    public void onClickRelatorio() {
        showLoading();
        requisitarArquivoChuvaPresenter.gerarRelatorio(editTextDtInicio.getText().toString(), editTextDtFim.getText().toString());
    }
