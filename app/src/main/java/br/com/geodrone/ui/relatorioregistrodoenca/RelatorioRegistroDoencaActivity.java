package br.com.geodrone.ui.relatorioregistrodoenca;
...
public class RelatorioRegistroDoencaActivity extends BaseRelatorioActivity implements DatePickerDialog.OnDateSetListener,
        RelatorioRegistroDoencaPresenter.View{
    ...
    private RelatorioRegistroDoencaPresenter requisitarArquivoDoencaPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_relatorio_registro_doenca);
        ...
        if (!Util.verificaConexao(this)){
            ...
            requisitarArquivoDoencaPresenter = new RelatorioRegistroDoencaPresenter(this);
    ...
    public void onPostCreate(Bundle savedInstanceState) {
        ...
        requisitarArquivoDoencaPresenter.takeView(this);
    }
    ...
    @OnClick(R.id.btn_req_relatorio)
    @Override
    public void onClickRelatorio() {
        showLoading();
        requisitarArquivoDoencaPresenter.gerarRelatorio(editTextDtInicio.getText().toString(), editTextDtFim.getText().toString());
    }
