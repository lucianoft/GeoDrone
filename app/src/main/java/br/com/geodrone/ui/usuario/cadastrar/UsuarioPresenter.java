package br.com.geodrone.ui.usuario.cadastrar;
...
public class UsuarioPresenter extends BasePresenter<UsuarioPresenter.View> {
    ...
    public Usuario salvar(String nome, String cpfCnpj, String telefone, String email, String senha, String confirmSenha) {

        try {

            boolean isOk = validarSalvar(nome, cpfCnpj, telefone, email, senha, confirmSenha);
            if (isOk) {
                ...
                usuario.setCpfCnpj(new NumberUtils().parseLongOnlyNumber(cpfCnpj));
                usuario.setEmail(email);
                usuario.setTelefone(telefone);
                usuario.setSenha(senha);
                usuario.setFlagPerfil(FlagPerfilUsuario.ADMINISTRADOR.getValue());
