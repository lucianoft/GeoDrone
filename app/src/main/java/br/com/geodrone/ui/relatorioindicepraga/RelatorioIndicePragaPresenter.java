...
public class RelatorioIndicePragaPresenter extends BasePresenter<RelatorioIndicePragaPresenter.View> {
    ...
    public RelatorioIndicePragaPresenter(BaseRelatorioActivity activity){
    ...
    public void gerarRelatorio(String dtInicio, String dtFim){
        try {
            ...
            final String fileName = "relatorioIndiceInfestacaoPraga" + System.currentTimeMillis() + ".pdf";
            ...
            Call<ResponseBody> call = client.findRelatorioIndicePraga(cliente.getId(), dtInicio, dtFim);
