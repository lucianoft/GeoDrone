...
public class AceiteUsuarioGeodronePresenter extends BasePresenter<AceiteUsuarioGeodronePresenter.View> {

    private static  String TAG = AceiteUsuarioGeodronePresenter.class.getName();
    ...
    public AceiteUsuarioGeodronePresenter(BaseActivity activity){
    ...
    public void aceite(Boolean isChecked){
        if (isChecked){
            ...
            usuario.setIndAceiteGeodrone(1);
