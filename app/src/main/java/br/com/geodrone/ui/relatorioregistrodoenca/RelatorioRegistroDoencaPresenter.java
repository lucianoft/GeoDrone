...
public class RelatorioRegistroDoencaPresenter extends BasePresenter<RelatorioRegistroDoencaPresenter.View> {
    ...
    public RelatorioRegistroDoencaPresenter(BaseRelatorioActivity activity){
    ...
    public void gerarRelatorio(String dtInicio, String dtFim){
        try {
            ...
            final String fileName = "relatorioDoenca" + System.currentTimeMillis() + ".pdf";
            ...
            Call<ResponseBody> call = client.findRelatorioRegistroDoenca(cliente.getId(), dtInicio, dtFim);
