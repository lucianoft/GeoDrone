...
public class RelatorioRegistroPragaPresenter extends BasePresenter<RelatorioRegistroPragaPresenter.View> {
    ...
    public RelatorioRegistroPragaPresenter(BaseRelatorioActivity activity){
