...
*/
public class RegistroCondicaoTempoDao extends AbstractDao<RegistroCondicaoTempo, Long> {
    ...
    public static class Properties {
        ...
        public final static Property IdRegistroCondTempo = new Property(4, Long.class, "idRegistroCondTempo", false, "ID_REGISTRO_COND_TEMPO");
    ...
    public RegistroCondicaoTempoDao(DaoConfig config) {
        super(config);
    }
    
    public RegistroCondicaoTempoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GEO_REGISTRO_COND_TEMPO\" (" + //
                ...
                "\"ID_REGISTRO_COND_TEMPO\" INTEGER," + // 4: idRegistroCondTempo
    ...
    protected final void bindValues(DatabaseStatement stmt, RegistroCondicaoTempo entity) {
        ...
        Long idRegistroCondTempo = entity.getIdRegistroCondTempo();
        if (idRegistroCondTempo != null) {
            stmt.bindLong(5, idRegistroCondTempo);
        }
