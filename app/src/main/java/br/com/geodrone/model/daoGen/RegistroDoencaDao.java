...
/** 
 * DAO for table "TB_REGISTRO_DOENCA".
*/
public class RegistroDoencaDao extends AbstractDao<RegistroDoenca, Long> {

    public static final String TABLENAME = "TB_REGISTRO_DOENCA";
    ...
    public static class Properties {
        public final static Property IdRegistroChuva = new Property(0, Long.class, "idRegistroChuva", true, "ID_REGISTRO_DOENCA");
        public final static Property IdDoencaRef = new Property(1, Long.class, "idDoencaRef", false, "ID_DOENCA_REF");
        ...
        public final static Property IdRegistroChuvaRef = new Property(10, Long.class, "idRegistroChuvaRef", false, "ID_REGISTRO_DOENCA_REF");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TB_REGISTRO_DOENCA\" (" + //
                ...
                "\"ID_REGISTRO_DOENCA_REF\" INTEGER," + // 10: idRegistroChuvaRef
                "\"ID_DISPOSITIVO\" INTEGER);"); // 11: idDispositivo
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TB_REGISTRO_DOENCA\"";
        db.execSQL(sql);
    }
